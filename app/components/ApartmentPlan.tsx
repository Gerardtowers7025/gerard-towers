...
> = {
  A: {
    ...
    images: ["/floorplans/images/A.png"],
  },
  B: {
    title: "B Line",
    ...
    images: ["/floorplans/images/B.png"],
  },
  C: {
    title: "C Line",
    ...
    images: ["/floorplans/images/C.png"],
  },
  D: {
    title: "D Line",
    ...
    images: ["/floorplans/images/D.png"],
  },
  E: {
    title: "E Line",
    ...
    images: ["/floorplans/images/E.png"],
  },
  F: {
    title: "F Line",
    ...
    images: ["/floorplans/images/F.png"],
  },
  G: {
    title: "G Line",
    info: "1 bed • 1 bath • ~738 sq ft",
    floors: "Lobby to 25th",
    layout: "Terrace with dining foyer",
    images: ["/floorplans/images/G.png"],
  },
  H: {
    title: "H Line",
    info: "1 bed • 1 bath • ~950 sq ft",
    ...
    images: ["/floorplans/images/H.png"],
  },
  J: {
    title: "J Line",
    info: "2 bed • 1 bath • ~1,570 sq ft",
    floors: "Lobby to 25th",
    layout: "Corner layout with terrace",
    images: ["/floorplans/images/J.png"],
  },
  K: {
    title: "K Line",
    info: "Studio/1 bed • 1 bath • ~613 sq ft",
    floors: "Lobby to 25th",
    layout: "Compact layout",
    images: ["/floorplans/images/K.png"],
  },
  L: {
    title: "L Line",
    info: "1 bed • 1 bath • ~617 sq ft",
    floors: "Lobby to 25th",
    layout: "Classic layout with dining foyer",
    images: ["/floorplans/images/L.png"],
  },
  M: {
    title: "M Line",
    ...
    images: ["/floorplans/images/M.png"],
  },
  N: {
    title: "N Line",
    ...
    images: ["/floorplans/images/N.png"],
  },
  O: {
    title: "O Line",
    ...
    floors: "Lobby to 25th",
    layout: "Long layout",
    images: ["/floorplans/images/O.png"],
  },
  P: {
    title: "P Line",
    ...
    floors: "Lobby to 25th",
    layout: "Compact layout",
    images: ["/floorplans/images/P.png"],
  },
  Q: {
    title: "Q Line",
    ...
    floors: "Lobby to 25th",
    layout: "Small layout",
    images: ["/floorplans/images/Q.png"],
  },
  R: {
    title: "R Line",
    ...
    images: ["/floorplans/images/R.png", "/floorplans/images/R2.png"],
  },
  S: {
    title: "S Line",
    ...
    images: ["/floorplans/images/S.png"],
  },
  T: {
    title: "T Line",
    ...
    floors: "Lobby to 18th",
    layout: "Terrace, flexible dining/bedroom layout",
    images: ["/floorplans/images/T.png"],
  },
  U: {
    title: "U Line",
    ...
    floors: "Lobby to 18th",
    layout: "Terrace layout",
    images: ["/floorplans/images/U.png"],
  },
  V: {
    title: "V Line",
    ...
    images: ["/floorplans/images/V.png"],
  },
  W: {
    title: "W Line",
    ...
    floors: "1st to 18th",
    layout: "Long layout",
    images: ["/floorplans/images/W.png"],
  },
  X: {
    title: "X Line",
    ...
    floors: "Splits: Lobby–18th / 19th–25th",
    layout: "Terrace layout",
    images: ["/floorplans/images/X.png", "/floorplans/images/X2.png"],
  },
  Y: {
    title: "Y Line",
    ...
    floors: "Lobby to 25th",
    layout: "Compact layout",
    images: ["/floorplans/images/Y.png"],
  },
  Z: {
    title: "Z Line",
    ...
    images: ["/floorplans/images/Z.png"],
  },
};
